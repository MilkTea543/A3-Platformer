...
public class Enemy : MonoBehaviour
{
    ...
    private FlickerOnDeath flickerOnDeath;
    ...
    void Awake()
    {
        ...
        flickerOnDeath = GetComponent<FlickerOnDeath>();
    ...
    {
        ren.color = color;
        yield return new WaitForSeconds(hitColorDuration); // Adjust this duration as needed
    ...
    void Death()
    {
        ...
        // Spawn a new enemy if enemyPrefab is set
